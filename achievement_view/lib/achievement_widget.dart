...
// TODO: This thing has multiple controllers. No, it should have one
// and drive all the animations off that one. Use Intervals
...
class AchievementWidgetState extends State<AchievementWidget>
  ...
  Animation<Offset> _buildAnimatedContent(AnimationController controller) {
    ...
    return Tween(begin: Offset(dx, dy), end: Offset(0.0, 0.0))
